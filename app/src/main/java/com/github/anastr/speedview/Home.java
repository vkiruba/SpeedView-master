...
public class Home extends FragmentActivity implements OnMapReadyCallback, LocationListener {
    ...
    public void onLocationChanged(Location location) {
        ...
        //double roundOff = Math.round(location.getSpeed() * 100.0) / 100.0;
        //  speed_txt.setText("" + roundOff + " kmph");
        deluxeSpeedView.setWithTremble(true);
        deluxeSpeedView.setWithEffects(true);
        deluxeSpeedView.speedTo(location.getSpeed());
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                //           speed_txt.setText("0.0 kmph");
                deluxeSpeedView.speedTo(0);
            }
        }, 3000);
    }
